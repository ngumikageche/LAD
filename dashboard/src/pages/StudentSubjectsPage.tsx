...
const StudentSubjectsPage = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-slate-900">My Subjects</h1>
          ...
          <article key={subject.id} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-2xl bg-slate-50 p-4">
                ...
                <p className="mt-2 font-medium text-slate-800">{subject.module?.name || 'Not assigned'}</p>
              </div>
              ...
              <div className="rounded-2xl bg-emerald-50 p-4">
                ...
                <p className="mt-2 font-medium text-slate-800">{subject.course?.name || 'No course linked'}</p>
              ...
              <div className="rounded-2xl bg-blue-50 p-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-blue-700">Assigned Trainers</p>
                <div className="mt-3 space-y-3">
                  {subject.trainers.length > 0 ? (
                    subject.trainers.map((trainer) => (
                      <div key={trainer.id} className="rounded-2xl bg-white p-3">
