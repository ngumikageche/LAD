...
const reportCards: ReportCard[] = [
  ...
  },
  {
    key: 'student-fees',
    title: 'Fee Statement',
    description: 'Student fee summary and payment status where finance data exists.',
    category: 'Finance',
    permission: 'reports.student.fees',
  ...
  },
  {
    ...
    description: 'Finance summary by course and outstanding balances where available.',
    category: 'Finance',
    permission: 'reports.admin.fees',
