...
const reportCards: ReportCard[] = [
  ...
  {
    key: 'practical-assessment-reports',
    title: 'Practical Assessments',
    description: 'Competency outcomes in summary, or learner records with the full task breakdown.',
    category: 'Academic',
    permission: 'reports.practical.assessment',
    path: '/reports/assessments/practical',
    icon: ClipboardList,
    roles: ['admin', 'trainer'],
  },
  {
    key: 'exam-results-analysis',
    title: 'Exam Results Analysis',
    description: 'Marks by assessment, subject, and course in summary, or every score entry in detail.',
    category: 'Academic',
    permission: 'reports.admin.pass_rate',
    path: '/reports/assessments/exams',
    icon: BarChart3,
    roles: ['admin', 'trainer'],
  },
  {
